...
const Hero = () => {
  ...
  return (
    <div className="pt-32 pb-24 md:pt-40 md:pb-32 bg-gradient-to-br from-gray-light to-white">
      ...
      <Dialog open={showDialog} onOpenChange={setShowDialog}>
        <DialogContent className="sm:max-w-lg bg-white rounded-lg p-8">
              ...
              <label key={num} className="flex items-center cursor-pointer">
                <div className="flex items-center justify-center w-6 h-6 mr-4">
                  <input
                    ...
                    onChange={() => handleBedroomSelect(num)}
                    className="hidden"
                  />
          ...
          <div className="mt-8">
            <Button 
              type="button"
              onClick={handleNextAfterBedrooms}
      ...
      <Dialog open={showBathroomsDialog} onOpenChange={setShowBathroomsDialog}>
        <DialogContent className="sm:max-w-lg bg-white rounded-lg p-8">
          <DialogHeader className="relative">
            <DialogTitle className="text-center text-2xl font-semibold">
              How many bathrooms?
              ...
              <label key={num} className="flex items-center cursor-pointer">
                <div className="flex items-center justify-center w-6 h-6 mr-4">
                  <input
                    ...
                    onChange={() => handleBathroomSelect(num)}
                    className="hidden"
                  />
          ...
          <div className="mt-8 flex justify-between gap-4">
            ...
            <Button 
              type="button"
              onClick={handleNextAfterBathrooms}
